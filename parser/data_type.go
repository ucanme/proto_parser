...
func (sdt ScalarDataType) DefaultValue() interface{} {
	switch sdt.Name() {
	case "bool":
		return false
	case "bytes":
	...
	case "double", "float":
		return 0.0
	case "fixed32", "fixed64", "int32", "int64", "sfixed32", "sfixed64", "sint32", "sint64", "uint32", "uint64":
		return 0
	}
	return nil
}
...
func (mdt MapDataType) DefaultValue() interface{} {
...
func (ndt NamedDataType) DefaultValue() interface{} {
	return nil
}
...
func NewEnumDataType(s string) (EnumDataType, error) {
	//key := strings.ToLower(s)

	return EnumDataType{}, nil
}

func (edt EnumDataType) Name() string {
	return edt.name
}

func (edt EnumDataType) Category() DataTypeCategory {
	return EnumDataTypeCategory
}

func (edt EnumDataType) DefaultValue() interface{} {
	return 0
}
